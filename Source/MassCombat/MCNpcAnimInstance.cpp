...
bool UMCNpcAnimInstance::IsMontageAlreadyPlaying(const UAnimMontage* Montage) const
{
...
void UMCNpcAnimInstance::PlayMontageSynced(UAnimMontage* Montage, float StartPosition, bool bInstantBlend)
{
	if (!Montage)
	{
		return;
