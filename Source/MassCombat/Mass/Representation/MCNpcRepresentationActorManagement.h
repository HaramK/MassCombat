...
#include "MCNpcRepresentationActorManagement.generated.h"

UCLASS()
class MASSCOMBAT_API UMCNpcRepresentationActorManagement : public UMassRepresentationActorManagement
{
	GENERATED_BODY()
