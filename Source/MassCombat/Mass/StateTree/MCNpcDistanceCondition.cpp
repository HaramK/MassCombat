#include "Mass/StateTree/MCNpcDistanceCondition.h"
#include "StateTreeExecutionContext.h"
#include "StateTreeLinker.h"

bool FMCNpcDistanceCondition::Link(FStateTreeLinker& Linker)
{
	Linker.LinkExternalData(CombatHandle);
	return true;
}

bool FMCNpcDistanceCondition::TestCondition(FStateTreeExecutionContext& Context) const
{
